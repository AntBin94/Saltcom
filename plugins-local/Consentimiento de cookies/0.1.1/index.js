...
const headers = (cfg) => [
  {
    script: `/plugins/public/consentimientocookies@${
  ...
  {
    css: `/plugins/public/consentimientocookies@${
      require("./package.json").version
    }/cookieconsent.css`,
  },
...
const buildConfigJS = async (context0) => {
  ...
  if (context.ads_present)
    categories.ads = { enabled: !!context.ads_default };
              ...
              ? [
                  {
                    ...
                    description:
                      context.ads_description ||
                      "Aceptar esta condicion nos da permiso a obtener tu correo electronico y enviarte los correos promocionales.",
                    linkedCategory: "ads",
                  },
                ]
              : []),
          ...
          return new Form({
            ...
            fields: [
              ...
              },
              {
                ...
                sublabel: "Enabled by default",
                type: "Bool",
                showIf: { ads_present: true },
              },
              {
                name: "ads_title",
                label: "Title",
                type: "String",
                default: "Quieres recibir correos promocionales?",
                showIf: { ads_present: true },
              },
              {
...
module.exports = {
  ...
  plugin_name: "consentimientocookies",
  headers,
